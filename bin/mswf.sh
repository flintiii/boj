...
## The syntax is:
##  - mswf.sh ounzip <folder>  <filename>  - Blows open an odt
##  - mswf.sh ozip   <folder> <filename> - makes odt
...
#
#* function ounzip - ounzip <folder>  <filename>  - Blows open an odt
function ounzip(){
echo "This is the \""$FUNCNAME"\" function in "$0" version "$version #debug
#
...
#
#
#* function ozip - ozip <folder> <filename> - makes odt
function ozip(){
# note that zip is a reserved word, so do not use it as a function name...
echo "This is the \""$FUNCNAME"\" function in "$0" version "$version #debug
#
